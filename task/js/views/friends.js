    ...
    const html = `
        <div class="modal-body" style="text-align:center;">
            ...
            <div style="display:flex; gap:8px;">
                <input type="text" id="search-username-input" placeholder="e.g. shadowhunter" style="flex:1; padding: 12px; border-radius:12px; border:2px solid var(--border-color); background:var(--bg-color); color:var(--text-primary);">
